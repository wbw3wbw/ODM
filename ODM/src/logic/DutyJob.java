...
public class DutyJob{
	...
	public void job0(){
		System.out.println("开始发送全天班提醒短信!");
		remind("0");
	}
	public void job1(){
		System.out.println("开始发送上午班提醒短信!");
		remind("1");
	}
	public void job2(){
		System.out.println("开始发送下午班提醒短信!");
		remind("2");
	}
	public void job3(){
		System.out.println("开始发送晚班提醒短信!");
		remind("3");
	}
	
    public void remind(String order) {
        try {
    		Date today=new Date();
